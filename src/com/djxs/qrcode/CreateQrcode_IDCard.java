...
public class CreateQrcode_IDCard {
	...
	public static void main(String[] args) throws IOException {
        ...
        String str="BEGIN:VCARD\n"+
                   "PHOTO;VALUE=uir:http://http://image.so.com/v?q=头像可爱卡通&src=srp&correct=可爱的卡通头像&cmsid=066dbc1e4de3a93b76e2f705334b28ff&cmran=0&cmras=0&cn=0&gn=0&kn=0#id=10d9db588148f89f4843b7cc1610500d&itemindex=0&currsn=\n" +
                   "FN:姓名:秦依\n"+
                   "TITLE:河北科技师范学院学生\n"+
        ...
        Image logo=ImageIO.read(new File("D:/头像/qyid.jpg"));
        int logosize=50;
